document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('/views/games/test_api/fetch_game_details.php', {
        method: 'POST',
...
function fetchPopularArticles (user) {
    ...
    fetch('/views/games/test_api/fetch_popular_articles.php')
    .then(response => {
        if (!response.ok) {
...
function openEditModal(article) {
    ...
    editArticleForm.onsubmit = function (e) {
        ...
        fetch('/views/games/test_api/update_article.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
function populateGameDetails(game, user) {
    ...
    game.genres.forEach(genre => {
        ...
        genreLink.href = `/views/store/category.php?category=${encodeURIComponent(genre)}`;  // Link to the category page
    ...
    if ((user['game-own'].includes(game.id) || game.is_free) && user.role === 'user') {
        ...
        //     window.location.href = `/views/games/test_api/download.php?game_id=${game.id}`;
        // });
    } else {
...
function addToCart(userId, gameId) {
    fetch('/views/games/test_api/add_to_cart.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ user_id: userId, game_id: gameId }),
    })
...
function setupReviewSection(game, user) {
    ...
    if (user.role === 'admin') {
        ...
        toggleButton.addEventListener('click', () => {
            fetch('/views/games/test_api/toggle_comments.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
function handleLikeDislike(user, gameId, review, action, likeBtn, dislikeBtn) {
    ...
    // Call API
    fetch('/views/games/test_api/update_like_dislike.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            game_id: gameId,
...
function sendReplyToBackend(gameId, reviewUsername, userId, replyMessage) {
    fetch('/views/games/test_api/submit_reply.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
            game_id: gameId,
...
function setupAdminReviewButtons(game) {
    ...
    document.querySelectorAll('.toggle-visibility-btn').forEach((button) => {
        button.addEventListener('click', (e) => {
            ...
            fetch('/views/games/test_api/update_review_visibility.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    game_id: gameId,
    ...
    document.querySelectorAll('.delete-review-btn').forEach((button) => {
        button.addEventListener('click', (e) => {
            ...
            fetch('/views/games/test_api/delete_review.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (reviewForm) {
        reviewForm.addEventListener('submit', (e) => {
            ...
            fetch('/views/games/test_api/submit_review.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    game_id: gameId,
