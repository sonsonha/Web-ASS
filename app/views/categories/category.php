...
<body>
    ...
    <section class="trending-carousel" id="trendingCarousel">
            <div class="carousel-header text-center text-white">
                <h1>Category game name (Strategy)</h1>
            </div>
        <div id="gameCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bg="/public/assets/images/game9.webp"> <!-- These background image is fetched from back-end corresponding to the game id-->
                    <div class="carousel-content">
                        <img src="/public/assets/images/game1.webp" class="game-image" alt="Game 1">
                        <div class="game-details">
                            <h2>Liar's Bar</h2> <!-- Game Title is fetched from back-end-->
                            <p>Release date: Oct 2, 2024</p>    <!-- Release date is fetched from back-end too-->
                            <p class="text-success">Very Positive | 12,906 User Reviews</p> <!-- Reviews are fetched from back-end-->
                            <div class="tags">  <!-- Tags are fetched from back-end-->
                                <span>Casual</span>
    ...
    <section class="game-cards container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <!-- Game Card Example -->
            <div class="col">
                <div class="card game-card"> <!-- These game card is fetched from back-end, corresponding to gern of the category -->
